...
install_atuin() {
    if ! command_exists atuin; then
        ...
        if command_exists brew; then
            ...
            # Looking for https://github.com/ellie/atuin/releases/download/v14.0.1/atuin_14.0.1_amd64.deb
            sudo apt install "https://github.com/ellie/atuin/releases/download/v$ATUIN_LATEST_VERSION/atuin_${ATUIN_LATEST_VERSION}_amd64.deb"
        fi
        if command_exists atuin; then
            atuin import auto
        fi
